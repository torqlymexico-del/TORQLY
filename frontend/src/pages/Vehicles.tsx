...
import { Search, Plus, Pencil, Trash2, Loader2, Car } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Dialog open={dialogOpen} onOpenChange={o => { if (!o) setDialogOpen(false); }}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>{editTarget ? "Editar vehículo" : "Nuevo vehículo"}</DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <Field label="Placas">
              <input
                className={inputCls}
                value={form.plates}
                onChange={e => set("plates", e.target.value.toUpperCase())}
                placeholder="ABC-123"
              />
            </Field>
